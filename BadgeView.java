package com.yuhaibo.testdemo.widget;
...
public class BadgeView extends android.support.v7.widget.AppCompatTextView {
    ...
    private static final boolean IS_ANIMATE = false;
    private static final int DEFAULT_BADGE_COLOR = Color.parseColor("#FF4531"); //红色
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.BadgeView);
        badgeColor = mTypedArray.getColor(R.styleable.BadgeView_badgeColor, DEFAULT_BADGE_COLOR);
        badgeTextColor = mTypedArray.getColor(R.styleable.BadgeView_badgeTextColor, DEFAULT_TEXT_COLOR);
        leftRightPadding = mTypedArray.getDimensionPixelSize(R.styleable.BadgeView_leftRightPadding, DEFAULT_LR_PADDING_DIP);
        topBottomPadding = mTypedArray.getDimensionPixelSize(R.styleable.BadgeView_topBottomPadding, DEFAULT_TB_PADDING_DIP);
        badgeCornerRadius = mTypedArray.getDimensionPixelSize(R.styleable.BadgeView_badgeCornerRadius, DEFAULT_CORNER_RADIUS_DIP);
        isAnimate = mTypedArray.getBoolean(R.styleable.BadgeView_isAnimate, IS_ANIMATE);
        mTypedArray.recycle();
    }
    ...
    private void init(Context context, View target, int tabIndex) {
        ...
        int paddingLRPixels = dipToPixels(leftRightPadding);
        int paddingTBPixels = dipToPixels(topBottomPadding);
        setPadding(paddingLRPixels, paddingTBPixels, paddingLRPixels, paddingTBPixels);
